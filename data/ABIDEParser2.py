...
data_folder2 = '/media/pjc/expriment/mdd_exam/pjc/EV_GCN-MDD/data/ABIDE_pcp/cpac/filt_noglobal'
...
def get_static_affinity_adj(features, pd_dict):
    pd_affinity = create_affinity_graph_from_scores(['SITE_ID','DSM_IV_TR'], pd_dict)
